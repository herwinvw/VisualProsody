...
import visualprosody.GaussianMixtureModel.GaussianMixture;
...
public class VisualProsodyLeNumericalDiffTest
{
    ...
    private GaussianMixture gmRollUnvoiced = new GaussianMixture(1, new MultivariateNormalDistribution(new double[] { 2, 1 },
            new double[][] { { 1, 0 }, { 0, 1 }, }));
    private GaussianMixture gmPitchUnvoiced = new GaussianMixture(1, new MultivariateNormalDistribution(new double[] { 0, 1 },
            new double[][] { { 1, 0 }, { 0, 1 } }));
    private GaussianMixture gmYawUnvoiced = new GaussianMixture(1, new MultivariateNormalDistribution(new double[] { -2, 1 },
            new double[][] { { 1, 0 }, { 0, 1 } }));
    ...
    public void setup()
    {
        ...
        vp = new VisualProsodyLeNumericalDiff(new GaussianMixtureModel(ImmutableList.of(gmRollVoiced)), new GaussianMixtureModel(
                ...
                mockGmmAcceleration, new GaussianMixtureModel(ImmutableList.of(gmRollUnvoiced)), new GaussianMixtureModel(
                        ImmutableList.of(gmPitchUnvoiced)), new GaussianMixtureModel(ImmutableList.of(gmYawUnvoiced)), mockGmmVelocity,
                mockGmmAcceleration);
    }
