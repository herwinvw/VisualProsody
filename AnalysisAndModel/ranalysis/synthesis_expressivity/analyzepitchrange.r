...
xlowhead<-read.csv("synthesis_expressivity/hawaii_pitchrange_xlow_hannah_head.csv")
lowhead<-read.csv("synthesis_expressivity/hawaii_pitchrange_low_hannah_head.csv")
normalhead<-read.csv("synthesis_expressivity/hawaii_pitchrange_medium_hannah_head.csv")
highhead<-read.csv("synthesis_expressivity/hawaii_pitchrange_high_hannah_head.csv")
xhighhead<-read.csv("synthesis_expressivity/hawaii_pitchrange_xhigh_hannah_head.csv")
